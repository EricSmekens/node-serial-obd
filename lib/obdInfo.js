...
responsePIDS = [
    ...
    //DTC's
    {mode: modeRequestDTC, pid: "N/A", bytes: 6, name: "requestdtc", description: "Vehicle Identification Number", convertToUseful: notSupported}, //n*6 --> For each code, 6 bytes.

    {mode: modeClearDTC, pid: "N/A", bytes: 0, name: "cleardtc", description: "Clear Trouble Codes (Clear engine light)", convertToUseful: notSupported},
