...
responsePIDS = [
    ...
    //DTC's
    {mode: modeRequestDTC, pid: undefined, bytes: 6, name: "requestdtc", description: "Vehicle Identification Number", convertToUseful: notSupported}, //n*6 --> For each code, 6 bytes.
