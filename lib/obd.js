...
//        var indexOf41 = currentString.indexOf('\r\n4');
        var indexOfEnd = currentString.lastIndexOf('\r\n>');

        if (indexOfEnd > -1) {
            //Discard end
            currentString = currentString.substr(0, indexOfEnd);

            var indexOfStart = currentString.lastIndexOf('\r\n');

            currentString = currentString.substr(indexOfStart+2, currentString.length);
